...
const GROUND_RESOLUTION := 220
const WATER_RESOLUTION := 170

const VEGETATION_COUNT := 380
const FOREST_CLUSTERS := 22
const TREES_PER_FOREST := 22
const FOREST_RADIUS := 22.0
const ROCK_COUNT := 480
const ORE_COUNT := 160
const CRATE_COUNT := 60
const CACTUS_COUNT := 260
const DESERT_VILLAGE_COUNT := 4
const SNOW_BUILDING_COUNT := 4
const SNOW_STATION_COUNT := 4
const SNOW_METRO_COUNT := 4
