...
- **Réseau de métro souterrain branché** (4 stations, zone enneigée) :
  ...
  station de métro industrielle abandonnée. Chaque quai est aussi
  **agrandi** (salle plus longue) et dispose d'une **mezzanine**
  surélevée avec rambarde rouge et son propre escalier, plus un
  chariot élévateur (forklift) posé sur le quai - pour se rapprocher
  de la grandeur d'une vraie station industrielle. Une **rame
  automatique** (deux wagons + phare) fait la tournée de toutes les
  branches en boucle - du vrai trafic souterrain sous la carte plutôt
  que des salles isolées
